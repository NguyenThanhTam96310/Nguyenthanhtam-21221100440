...
///index.php?option=product&slug=
$list_id = array();
array_push($list_id, $catid);
$mod_menu_listcategory1 = Category::where([['parent_id', '=', $catid], ['status', '=', 1]])
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-6">
            ...
            <h2 class="text-main py-4">Giá: <?= number_format($pro->price); ?></h2>
            <div class="mb-3 product-size">
               <input id="sizexxl" type="radio" class="d-none" value="xxl" name="size">
               <label for="sizexxl" class="bg-info p-2">128GB</label>
               <input id="sizexl" type="radio" class="d-none" value="xl" name="size">
               <label for="sizexl" class="bg-info p-2 px-3">256GB</label>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
               ...
               <!-- <a class="btn btn-main" href="checkout.html">
...
<script>
   function addcart(id) {
      ...
      //thêm vào giỏ hàng với kĩ thuật AJAX
      $.ajax({
