...
//$customer =  Customer::where([['status', '=', 1], ['id', '=', $_SESSION['customer_id']]])->get();
      ...
      <div class="row">
         <div class="col-md-3 order-2 order-md-1">
            <ul class="list-group mb-3 list-category">
               ...
               <li class="list-group-item">
                  <a href="index.php?option=customer&profile-changepassword">Đổi mật khẩu</a>
               </li>
               <li class="list-group-item">
         ...
         <div class="col-md-9 order-1 order-md-2">
            ...
            <table class="table table-borderless">
               ...
               <tr>
                  ...
                  <td><?= $customer->customername; ?> <a href="index.php?option=customer&profile-changepassword">Đổi mật khẩu</a> </td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td><?= $customer->address; ?> <a href="index.php?option=customer&profile-edit">Đổi địa chỉ</a> </td>
               </tr>
            </table>
         </div>
      </div>
