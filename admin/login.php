...
<body>
    ...
    <form action="login.php" method="post">
        <div class="swapper mt-5 p-3">
            <h1 class="text-danger fs-1 text-center">ĐĂNG NHẬP</h1>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="password" name="password" placeholder="Mật khẩu" require>
            </div>
            <div class="mb-3 text-end">
                <input class="btn btn-success" type="submit" value="Đăng nhập" name="DANGNHAP">
            </div>
            <div class="mb-3">
                <p>Chú ý (*) bắt buộc phải ghi thông tin</p>
                <?php if ($error != "") : ?>
